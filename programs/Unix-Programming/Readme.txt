...
3b. Write shell script to implement terminal locking (similar to the lock command). It should
...
4b. Write a shell script that displays all the links to a file specified as the first argument
...
7b Write a shell script that accept a list of filenames as its argument, count and report
...
8b Write a shell script that reports the logging in of a specified user within one minute after
...
9b. Write a shell script that folds long lines into 40 columns. Thus any line that exceeds
...
10b. Write an awk script to delete duplicated line from a text file. The order of the
...
11b. Write an awk script to compute gross salary of an employee accordingly to rule given
below.
